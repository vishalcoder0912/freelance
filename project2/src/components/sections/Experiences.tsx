          ...
          {experiences.map((exp, index) => (
            ...
            >
              <div>
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-[10px] text-[#d4af37] font-semibold uppercase tracking-wider font-sans mb-3">
                ...
                <p className="text-[#c8b5a4]/90 text-xs md:text-sm mt-3.5 leading-relaxed font-light">
                  {exp.description}
                </p>
              </div>

              <div className="mt-8 pt-5 border-t border-[#c58c48]/10 flex items-center justify-between">
