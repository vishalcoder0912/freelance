...
export default function Testimonials() {
  ...
  return (
    <section className="relative py-24 md:py-36 bg-[#0c0807] px-6 md:px-12 border-t border-[#e5ad6b]/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 md:gap-16">
          {reviews.map((item, index) => (
            ...
            >
              ...
              {/* Reviewer Details */}
              <div className="mt-8 pt-6 border-t border-[#c58c48]/15 flex flex-col">
                <span className="text-xs font-serif text-[#f8eadc] font-medium tracking-wide">
                  {item.author}
                </span>
                <div className="flex items-center justify-between mt-1.5 text-[9px] uppercase tracking-wider text-[#c8b5a4]/70">
