    ...
    <div ref={containerRef} id="story" className="relative bg-[#090605]">
      ...
      <div className="relative h-screen overflow-hidden flex items-center">
        ...
        <div
          ...
          className="flex flex-nowrap items-center px-12 md:px-24 h-full relative z-20"
          style={{ width: "fit-content" }}
        >
          {/* Static Title Card inside horizontal slide */}
          <div className="w-[80vw] md:w-[45vw] flex-shrink-0 flex flex-col justify-center pr-16 select-none">
            <span className="text-[10px] font-sans font-semibold uppercase tracking-[0.4em] text-[#d4af37]">
              Our Craft
            </span>
            <h2 className="font-serif text-4xl md:text-6xl font-bold tracking-tight text-[#f8eadc] mt-4 leading-tight font-serif">
              The <br />
              <span className="italic text-gold-gradient">Bean-To-Bar</span> <br />
              Journey.
            </h2>
            <p className="text-[#c8b5a4] text-xs md:text-sm mt-6 font-light leading-relaxed max-w-sm">
            ...
            <div className="relative w-40 h-[2px] bg-[#34211a] mt-12 rounded-full overflow-hidden">
          ...
          {steps.map((step, idx) => (
            <div
              key={step.number}
              className="timeline-card w-[85vw] md:w-[65vw] flex-shrink-0 mr-16 md:mr-24 flex flex-col justify-center h-[85vh] relative"
            >
              ...
              <div className="w-full relative rounded-md overflow-hidden border border-[#c58c48]/15 bg-[#140d0b]">
                ...
                <div className="absolute top-0 bottom-0 left-12 w-[1px] bg-gradient-to-b from-transparent via-[#e5ad6b]/15 to-transparent z-10" />
              </div>

              {/* Text Meta Info */}
              <div className="mt-8 grid grid-cols-[80px_1fr] md:grid-cols-[100px_1fr] items-start gap-4">
                <span className="font-serif text-3xl md:text-5xl font-bold italic text-[#d4af37]/50 tracking-wide">
                  {step.number}
                </span>
                <div>
                  ...
                  <h3 className="font-serif text-xl md:text-2xl text-[#f8eadc] mt-1 font-medium">
                    {step.title}
                  </h3>
                  <p className="text-[#c8b5a4]/90 text-xs md:text-sm font-light mt-3 leading-relaxed max-w-2xl">
                    {step.description}
                  </p>
                </div>
              </div>
          ...
          {/* End Card */}
          <div className="w-[60vw] md:w-[35vw] flex-shrink-0 flex flex-col justify-center pl-8">
            <h3 className="font-serif text-3xl md:text-4xl text-[#f8eadc] leading-tight">
              A Ritual of <br />
              <span className="text-gold-gradient italic">Pure Indulgence.</span>
            </h3>
            <p className="text-[#c8b5a4] text-xs md:text-sm mt-4 font-light leading-relaxed max-w-xs">
              No soy lecithin, no artificial vanilla, no shortcuts. Just pure cacao and raw sugar.
            </p>
            <a
              href="#collection"
              className="mt-8 self-start text-[10px] uppercase tracking-[0.25em] font-semibold text-[#e5ad6b] hover:text-[#f8eadc] transition-colors duration-300"
            >
              Indulge Now &rarr;
            </a>
          </div>
