...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#0c0807] pt-24 border-t border-[#e5ad6b]/10 overflow-hidden">
      
      {/* Footer Directory Info */}
      <div className="container mx-auto px-6 md:px-12 max-w-7xl pb-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="#collection" className="text-xs text-[#c8b5a4] hover:text-[#e5ad6b] transition-colors">
              Bar Selection
            </a>
            <a href="#collection" className="text-xs text-[#c8b5a4] hover:text-[#e5ad6b] transition-colors">
              Tasting packs
        ...
        <div className="mt-16 pt-8 border-t border-[#c58c48]/10 flex flex-col sm:flex-row items-center justify-between text-[10px] tracking-widest text-[#c8b5a4]/50 uppercase gap-4">
