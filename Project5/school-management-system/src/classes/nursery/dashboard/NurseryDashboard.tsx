...
const quickActions = [
  ...
  { title: 'Fruits', icon: '🍎', path: '/nursery/fruits-learning', color: 'red' },
  { title: 'Vegetables', icon: '🥕', path: '/nursery/vegetables-learning', color: 'orange' },
  { title: 'Transport', icon: '🚗', path: '/nursery/transport-learning', color: 'teal' },
  { title: 'Stories', icon: '📚', path: '/nursery/story-world', color: 'purple' },
  { title: 'Memory', icon: '🧠', path: '/nursery/memory-games', color: 'pink' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-6 pb-24">
        ...
        <div className="mb-6">
          <ProgressBar
            ...
            color="bg-gradient-to-r from-kid-orange via-kid-pink to-kid-purple"
            showPercent
            size="lg"
          />
        </div>
        ...
        <motion.div className="mb-8" variants={containerVariants} initial="hidden" animate="visible">
          <div className="flex items-center justify-between mb-4">
            ...
            <motion.button
              onClick={() => navigate('/nursery/alphabets')}
              className="text-sm text-kid-orange font-semibold flex items-center gap-1 hover:gap-2 transition-all"
              whileHover={{ x: 3 }}
            >
            ...
            {nurseryModules.map((module) => {
              ...
              return (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => navigate(`/nursery/${module.id}`)}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <motion.button
              onClick={() => navigate('/nursery/rewards')}
            ...
            <div className="flex flex-wrap gap-2">
              {['🧩', '🧠', '🔤', '🔢', '🎨', '🐾'].map((emoji, i) => (
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => navigate('/nursery/memory-games')}
                >
                  {emoji}
                </motion.button>
              ))}
