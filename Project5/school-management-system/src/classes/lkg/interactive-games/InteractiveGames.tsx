// InteractiveGames - Game selection hub for LKG
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 p-4">
      <div className="max-w-lg mx-auto">
        {/* Dynamic back button */}
        <motion.button
          onClick={() => activeGame ? setActiveGame(null) : navigate('/lkg')}
          className="mb-4 flex items-center gap-2 text-gray-600 font-semibold"
          whileHover={{ x: -3 }}
        >
          <ArrowLeft className="w-5 h-5" /> {activeGame ? 'Back to Games' : 'Back to LKG'}
        </motion.button>
