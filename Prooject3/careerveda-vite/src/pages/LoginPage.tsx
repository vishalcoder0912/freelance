...
import { Brain, ArrowLeft, Mail, Lock, ShieldAlert, Sparkles } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Auto-complete pending purchase on login
      ...
      <div className="lg:col-span-5 flex flex-col justify-center px-8 md:px-16 lg:px-20 py-12 relative z-10">
        ...
        <div className="max-w-md w-full mx-auto space-y-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-500 text-xs">Enter your details to access your career dashboard.</p>
          </div>
      ...
      <div className="hidden lg:col-span-7 bg-indigo-900 text-white relative lg:flex flex-col justify-between p-20 overflow-hidden">
        ...
        <div className="relative z-10 p-6 bg-white/5 border border-white/10 rounded-2xl max-w-sm">
          ...
          <div className="mt-4 flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-indigo-300/30 flex items-center justify-center font-bold text-xs">S</div>
            <div>
              <p className="text-xs font-bold">Siddharth Mehta</p>
              <p className="text-[9px] text-indigo-300">AI Engineer at Razorpay</p>
            </div>
          </div>
        </div>
