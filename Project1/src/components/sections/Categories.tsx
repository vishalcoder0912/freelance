...
export default function Categories() {
  const categories: CategoryItem[] = [
    ...
    },
    {
      ...
      src: "/images/product-1.jpg", // reuse product image
      href: "/shop",
      gridSpanClass: "md:col-span-1 md:row-span-1",
      aspectRatio: "4:5",
    },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-7xl">
        {/* Section Header */}
        <div className="mb-10 md:mb-20 text-center md:text-left max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          {categories.map((cat, index) => (
            <motion.a
              key={cat.title}
              href={cat.href}
              className={`group block relative rounded-md overflow-hidden bg-[#140d0b] border border-[#c58c48]/10 p-3 md:p-4 transition-all duration-700 hover:border-[#e5ad6b]/30 hover:shadow-[0_20px_60px_rgba(0,0,0,0.4)] ${cat.gridSpanClass}`}
            ...
            >
              <div className="relative overflow-hidden w-full h-full flex flex-col justify-between">
                ...
                <div className="flex flex-col gap-0.5 md:gap-1">
                  ...
                  <p className="text-[#c8b5a4]/80 text-xs md:text-sm font-light mt-1.5 md:mt-2 leading-relaxed">
                    {cat.description}
                  </p>
                </div>
              </div>
